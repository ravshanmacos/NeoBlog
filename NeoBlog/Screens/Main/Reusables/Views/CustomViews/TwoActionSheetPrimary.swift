...
class TwoActionSheetPrimary: BaseView {
    ...
    override func setupSubviews() {
        ...
        btnsVStack.snp.makeConstraints { make in
            make.top.equalTo(headerVStack.snp.bottom).offset(20)
...
extension TwoActionSheetPrimary {
    ...
    static func makeFirstActionBtn() -> UIButton {
        ...
        button.backgroundColor = R.color.red_color_1()
        return button
    }
